...
export default {
  async fetch(request, env) {
    ...
    async function sendAdminPanel(chatId, topicId, privateChatId, messageId) {
      ...
      const buttons = [
        ...
        [
          ...
          { text: '私聊', url: 'https://t.me/Vinatin' }
        ],
        [
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/duki-web/ctt/refs/heads/main/CFTeleTrans/start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/duki-web/ctt/refs/heads/main/CFTeleTrans/notification.md');
